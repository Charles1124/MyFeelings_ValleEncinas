package valle.carlos.myfeelings
...
import valle.carlos.myfeelings.utilities.CustomBarDrawable
import valle.carlos.myfeelings.utilities.CustomCircleDrawable
import valle.carlos.myfeelings.utilities.Emociones
import valle.carlos.myfeelings.utilities.JSONFile
...
class MainActivity : AppCompatActivity() {
    ...
    fun iconoMayoria(){
        ...
        if (verySad>veryHappy && verySad>neutral && verySad>happy && verySad>sad){
            icon.setImageDrawable(resources.getDrawable(R.drawable.baseline_sentiment_very_dissatisfied_24))
        }
